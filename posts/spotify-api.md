...
# Consume Spotify API
### Objektif:
- Melakukan consume pada Spotify API
- Opsi Genre, dan Playlists berdasarkan akun user
- Fitur search untuk mendapatkan song list dan song detail
- [Full Code here..](https://github.com/samsleepingatparty/SpotifyAPI-Test)
...
const APIController = (function() {
    ...
    const clientId = '492863a4c49d4c8980b877d7f296d740';
    const clientSecret = '537d93264ff84396b9cf823383480f48';
...
<head>
    ...
    <title>Spotify Web API Test</title>
...
<body>
    <div class="container">
        <form action="">
            ...
            <div class="col-sm-6 form-group row px-0">
                <label for="Playlist" class="form-label col-sm-2">Playlists:</label>
    ...
    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" rossorigin="anonymous"></script>
